...
-(void)generalNetworkWithNoCheck2:(NSString*)serverurl Data:(NSDictionary*)questionDict withCompletionBlock:(NetworkCompletionBlock)completionBlock method:(NSString*)method{
...
-(void)ontemplateRequestWithNoCheck2:(id) data Path:(NSString*)path  withCompletionBlock:(NetworkCompletionBlock)completionBlock method:(NSString*)method{
    NSString *serverurl = g_baseUrl ;
    ...
    [self generalNetworkWithNoCheck2:serverurl Data:questionDict withCompletionBlock:completionBlock method:method];
}
...
-(void)ontemplateGeneralRequestWithRawUrlNoCheck:(id) data Path:(NSString*)url withCompletionBlock:(NetworkCompletionBlock)completionBlock{
    ...
    [self generalNetworkWithNoCheck:serverurl Data:questionDict withCompletionBlock:completionBlock method:@"GET"];
}
