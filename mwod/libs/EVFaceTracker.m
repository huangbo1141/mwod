...
-(void)setViewInfo:(UIView *)viewPreView Rect:(CGRect)rt{
    _viewPreView = viewPreView;
    if (previewLayer!=nil) {
        [viewPreView.layer addSublayer:previewLayer];
//        [viewPreView.layer setFrame:rt];
        [previewLayer setFrame:CGRectMake(0, 0, rt.size.width, rt.size.height)];
    }
}
- (void)dealloc {
...
//    CGFloat padx = 20;
//    CGFloat pady = 20;
//    CGFloat ratio = 320.0f/300.0f;
//    CGRect viewRt = CGRectMake(padx, pady, scRect.size.width-2*padx, (scRect.size.width-2*padx)*ratio);
//    [previewLayer setFrame:viewRt];
    [previewLayer setFrame:CGRectMake(0,0,320,480)];
//    CGRect rect = [UIScreen mainScreen].bounds;
//    [previewLayer setFrame:CGRectMake(0, 20,rect.size.width, rect.size.height-20)];
